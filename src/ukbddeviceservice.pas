        ...
        begin
          ...
          begin
            ...
            begin
              ...
              Glb.LuaEngine.OnDeviceEvent(lDev, buff^.data.keyboard.VKey, lDirection);
            end;
...
begin
  ...
  Result := Format('message %s, key code %d [%s], extended %d, direction %s, keyboard handle %d',
    [GetMessageId(rawdata^.data.keyboard.Message), rawdata^.data.keyboard.VKey,
     GetCharFromVirtualKey(rawdata^.data.keyboard.VKey), rawdata^.data.keyboard.ExtraInformation,
